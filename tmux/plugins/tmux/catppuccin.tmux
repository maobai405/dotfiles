...
# status
 ...
 # readonly show_window_in_window_status_current="#[fg=$thm_fg,bg=$thm_gray] #W #[fg=$thm_bg,bg=$thm_orange] #I#[fg=$thm_orange,bg=$thm_bg]#[fg=$thm_fg,bg=$thm_bg,nobold,nounderscore,noitalics] "
  readonly show_window_in_window_status="#[fg=$thm_pink,bg=$thm_bg]#[fg=$thm_black4,bg=$thm_pink]#{b:pane_current_path} #[fg=$thm_black4,bg=$thm_pink] #I#[fg=$thm_pink,bg=$thm_bg]#[fg=$thm_pink,bg=$thm_bg] "
  ...
  readonly show_window_in_window_status_current="#[fg=$thm_red,bg=$thm_bg]#[fg=$thm_bg,bg=$thm_red]#{b:pane_current_path} #[fg=$thm_bg,bg=$thm_red] #I#[fg=$thm_red,bg=$thm_bg]#[fg=$thm_red,bg=$thm_bg] "
